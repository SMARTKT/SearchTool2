...
if __name__ == "__main__":
    ...
    parser.add_argument(dest='ALLSTORE',action='store',help='Input the path to all store file')
    parser.add_argument(dest='OUTDIR',action='store',help='Input the path where intermediate outputs will be stored')
    ...
    with open(os.path.join(args['OUTDIR'],'comment_tagged_tokens.csv'), 'w') as myfile:
        wr = csv.writer(myfile, delimiter = '\n')
        wr.writerow(all_tagged_comment_tokens)


    with open(os.path.join(args['OUTDIR'],'comment_tokens.csv'), 'w') as myfile:
        wr = csv.writer(myfile, delimiter = '\n')
        wr.writerow(all_comment_tokens)

    pickle.dump( all_comment_tokens, open( os.path.join(args['OUTDIR'],"comment_tokens.p"), "wb" ) )

# Execution command : python parsing_comment.py ../../xml_csv_files/threads\ XML/final_comments.xml ../../TTL\ files/threads\ TTL/final_comments.ttl ../../Data\ files/mapping_threads_static.p <path to all store file> <path to output folder>
