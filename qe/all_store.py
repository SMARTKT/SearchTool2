...
parser.add_argument(dest='outputPath', action='store', help='Input the file path where the output all_store.p file is to be written')
...
pickle.dump( all_store, open( outputPath, "wb" ) )
