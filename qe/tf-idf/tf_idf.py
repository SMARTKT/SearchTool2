...
pickle_file1 = sys.argv[1]#"../../Data files/mrfs_file_token_count.p"
pickle_file2 = sys.argv[2]#"../../Data files/mrfs_token_file_count.p"
...
pickle.dump( tf_idf, open( sys.argv[3], "wb" ) ) #"../../Data files/mrfs_tf_idf_name_tokens.p"
