...
name_token_similar_file = sys.argv[1]
name_tokens_dict_file = sys.argv[2]

with open(name_token_similar_file) as csvfile:
...
pickle.dump( name_tokens_dict, open( name_tokens_dict_file, "wb" ) )