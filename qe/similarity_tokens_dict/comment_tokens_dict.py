...
top10_similar_file = sys.argv[1]
comment_tokens_dict_file = sys.argv[2]

f=pd.read_csv(top10_similar_file)
...
pickle.dump( name_tokens_dict, open( comment_tokens_dict_file, "wb" ) )